...
#ifndef TEST_VEHICLE_GENERATION_H_
#define TEST_VEHICLE_GENERATION_H_
#include "test.h"
#include "core/factories/road_factory.h"
#include "core/factories/vehicle_factory.h"


class test_vehicle_generation : public test
{
public:
	test_vehicle_generation(){};
	virtual ~test_vehicle_generation(){};
	void runtest()
	{
		float init_density = 0.94;
		float step = 0.02;
...
#endif /* TEST_VEHICLE_GENERATION_H_ */
